...
É a sua vez de jogar! Mova uma <!-- BEGIN TURN -->peça branca<!-- END TURN -->.
...
| **4** | <img src="img/white/pawn.svg" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/white/pawn.svg" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/white/bishop.svg" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/blank.png" width=50px> | **4** |
...
| **2** | <img src="img/white/rook.svg" width=50px> | <img src="img/white/pawn.svg" width=50px> | <img src="img/white/pawn.svg" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/white/rook.svg" width=50px> | <img src="img/white/pawn.svg" width=50px> | <img src="img/white/pawn.svg" width=50px> | <img src="img/white/pawn.svg" width=50px> | **2** |
...
| :----: | :---------------------- |
| **A2** | [A3](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+A2+to+A3) |
| **A4** | [A5](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+A4+to+A5), [B5](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+A4+to+B5) |
| **B2** | [B3](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+B2+to+B3), [B4](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+B2+to+B4) |
| **D1** | [D2](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+D1+to+D2), [C1](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+D1+to+C1) |
| **E1** | [E2](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+E1+to+E2) |
| **F2** | [F3](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+F2+to+F3) |
| **G1** | [F3](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+G1+to+F3) |
| **G2** | [G3](https://github.com/marcizhu/marcizhu/issues/new?body=Por+favor+n%C3%A3o+mude+o+t%C3%ADtulo.+Apenas+clique+em+%22Submit+new+issue%22.+Voc%C3%AA+n%C3%A3o+precisa+fazer+mais+nada+%3AD&title=Chess%3A+Move+G2+to+G3) |
<!-- END MOVES LIST -->
...
Encontrou algum erro? Algo faltando? Sinta-se à vontade para abrir uma [issue](https://github.com/marcizhu/readme-chess/issues) e eu tentarei consertar o mais rápido possível :D


<details>
  <summary>Últimos 5 movimentos neste jogo</summary>
  <!-- BEGIN LAST MOVES -->

| Movimento | Autor |
| :--: | :----- |
| `A6` para `B5` | [ @MatthiasGN](https://github.com/MatthiasGN) |
| `F1` para `B5` | [ @MatissesProjects](https://github.com/MatissesProjects) |
| `B4` para `C3` | [ @MatthiasGN](https://github.com/MatthiasGN) |
| `E2` para `E3` | [ @MatissesProjects](https://github.com/MatissesProjects) |
| `B5` para `B4` | [ @MatthiasGN](https://github.com/MatthiasGN) |

<!-- END LAST MOVES -->
</details>

<details>
  <summary>Top 10 usuários com mais movimentos em todos os jogos</summary>
  <!-- BEGIN TOP MOVES -->

| Total de movimentos |  Usuário  |
| :---------: | :----- |
| 692 | [@JohnyP36](https://github.com/JohnyP36) |
| 385 | [@marcizhu](https://github.com/marcizhu) |
...
| 93 | [@MatthiasGN](https://github.com/MatthiasGN) |
| 74 | [@huuquyet](https://github.com/huuquyet) |
| 69 | [@lulunac27a](https://github.com/lulunac27a) |
